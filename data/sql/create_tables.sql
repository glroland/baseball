...
(
    ...
    is_interference_or_obstruction boolean not null,
    is_reached_on_error boolean not null,
    is_other_out boolean not null,
    is_other_no_out boolean not null,
    legacy_oth_total int not null,
    ...
    runner_left_on_base_1 varchar(8),
    runner_left_on_base_2 varchar(8),
    runner_left_on_base_3 varchar(8),
    pitcher_resp_for_runner_1_pre varchar(8),
    pitcher_resp_for_runner_2_pre varchar(8),
    pitcher_resp_for_runner_3_pre varchar(8),
    pitcher_resp_for_runner_1_post varchar(8),
    pitcher_resp_for_runner_2_post varchar(8),
    pitcher_resp_for_runner_3_post varchar(8),
